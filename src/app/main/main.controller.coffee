  ...
  .controller "MainCtrl", ($scope) ->
    $scope.awesomeThings = [
      ...
      },
      {
        ...
        'description': 'Stylus is a revolutionary new language, providing an' +
        ' efficient, dynamic, and expressive way to generate CSS. Supporting both an indented syntax and regular CSS style.',
        'logo': 'stylus.png'
      },
      {
        'title': 'CoffeeScript',
